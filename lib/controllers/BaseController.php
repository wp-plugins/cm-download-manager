...
abstract class CMDM_BaseController
{
    ...
    const PAGE_ADDONS_URL = 'https://www.cminds.com/store/?showfilter=No&tags=Download&nitems=3';
...
//        flush_rewrite_rules();
        ...
        if(!is_admin()) wp_enqueue_style('CMDM-css', CMDM_URL . '/views/resources/app.css');
    }
